    ...
    return (
      <Layout color="#F8FCFF">
        ...
        <div css={{
          ...
          <h2 css={{fontFamily: 'Nunito', fontSize: '24px', fontWeight: 'bold'}}>General information about cookies and how they are used</h2>
          <h3 css={{fontFamily: 'Nunito', fontSize: '16px', fontWeight: 'Regular'}}>
          ...
          <h2 css={{fontFamily: 'Nunito', fontSize: '24px', fontWeight: 'bold'}}>Necessary cookies</h2>
          <h3 css={{fontFamily: 'Nunito', fontSize: '16px', fontWeight: 'Regular'}}>
          ...
          <h2 css={{fontFamily: 'Nunito', fontSize: '24px', fontWeight: 'bold'}}>Analytical cookies</h2>
          <h3 css={{fontFamily: 'Nunito', fontSize: '16px', fontWeight: 'Regular'}}>
          ...
          <h2 css={{fontFamily: 'Nunito', fontSize: '24px', fontWeight: 'bold'}}>Marketing cookies</h2>
          <h3 css={{fontFamily: 'Nunito', fontSize: '16px', fontWeight: 'Regular'}}>
