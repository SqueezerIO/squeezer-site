...
import chainImage from '../../../../static/images/Squeezer_Assets_chainkit_page/chainicon.png';
    ...
    return (
      <div css={{ minHeight: '90vh', marginTop: '20rem', [presets.Hd]: { minHeight: '30vh' }, [presets.Phablet]: { minHeight: '20vh' } }}>
        <div css={{ margin: '0 auto', maxWidth: '1200px', position: 'relative' }}>
          <div css={{
            position: 'absolute', width: '100%', zIndex: '200', [presets.Hd]: { marginTop: '100px' }, [presets.Desktop]: { marginTop: '0px' },
            [presets.Desktop]: { position: 'relative' }
          }}>
            <div css={{
              height: '100%', width: '520px', position: 'relative', marginLeft: '150px', marginTop: '-40px', [presets.Hd]: { width: 'auto' },
            ...
            <div css={{
              position: 'relative', width: '100%', display: 'flex', flexWrap: 'wrap', marginTop: '76px', paddingLeft: '68px',
              ...
              <div css={{ display: 'flex', flex: 1, flexDirection: 'column', flexWrap: 'wrap', alignContent: 'left', [presets.Desktop]: { marginLeft: 0 } }}>
